...
"""
1. are links correct? 
2. print correct source and destination
3. can we undo installation process?
4. can we install locally, without root:
    - lazygit
    - vifm
"""
  ...
  %(prog)s --rollback               # Rollback last installation
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "(oh_my_bash_installation, dotfiles, oh_my_bash_configuration, config, fzf)"
        )
    )
